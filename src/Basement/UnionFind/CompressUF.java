 ...
 * It's takes 9 seconds around. it's the best method for the UF question.
 */
public class CompressUF {
    private int [] id;
    private int [] sz;
    private int count;
    ...
    public int find(int p)
    {
        ...
        //take all nodes directly to the root.
        while (orignalP != id[orignalP])
        {
            orignalP = id[orignalP];
            id[orignalP] = p;
        }
        return p;
    }
